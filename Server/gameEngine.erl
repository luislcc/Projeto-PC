...
create_player(State,Pid,Username,Rad) ->
	...
	Info4 = maps:put(energy,100.0,Info3),
	Info5 = maps:put(velocity,min_velocity(),Info4),
	Info6 = maps:put(l_velocity,0.0,Info5),
	Info7 = maps:put(f_acceleration,0.0,Info6),
	Info8 = maps:put(l_acceleration,0.0,Info7),
	Info9 = maps:put(r_acceleration,0.0,Info8),
	...
	Info15 = maps:put(r_velocity,0.0,Info14),
